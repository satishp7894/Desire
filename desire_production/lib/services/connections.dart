class Connection {
  ...
  static final String ip =
      'http://loccon.in/desiremoulding/api/ProductionApiController/';
  static final String ipUsers =
      'http://loccon.in/desiremoulding/api/UserApiController/';
  static final String ipSales =
      'http://loccon.in/desiremoulding/api/SalesApiController/';
  static final String ipAdmin =
      'http://loccon.in/desiremoulding/api/AdminApiController/';
  ...
  static final String productionUerProfile = ip + "productionUserProfile";
  ...
  //Notification
  static final String productiontoNotificationSales =
      ip + "productiontoNotificationSales";
