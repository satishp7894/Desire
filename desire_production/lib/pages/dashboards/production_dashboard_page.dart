...
class DashboardPageProduction extends StatefulWidget {
  ...
  @override
  _DashboardPageProductionState createState() => _DashboardPageProductionState();
}
...
class _DashboardPageProductionState extends State<DashboardPageProduction> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        return widget.page == "production" ? Alerts.showAlertExit(context, "Exit", "Are you sure?") : Navigator.pushReplacement(context, MaterialPageRoute(builder: (context){
  ...
  Widget _body(){
    ...
    return RefreshIndicator(
      color: kPrimaryColor,
      onRefresh: (){
        return Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (b) => DashboardPageProduction(page: widget.page,)), (route) => false);
      },
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (b) => DailyOrdersPage(page: widget.page,)));
              },
              child: Container(
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (b) => DailyProductionListPage(page: widget.page,)));
              },
              child: Container(
                decoration: BoxDecoration(
                  boxShadow: [
            ...
            SizedBox(height: 20,),
             widget.page == "production"?  GestureDetector(
               onTap: (){
                    ...
                    return Row(
                      ...
                      children: [
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text("Daily Orders",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.bold),),
                            SizedBox(height: 10,),
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text("Daily Production",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.bold),),
                            SizedBox(height: 10,),
                            Text("0",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.bold),),
                          ],
                        ),
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text("Planning",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.bold),),
                            SizedBox(height: 10,),
                            Text("No Planning",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ],
                    );
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text("Daily Orders",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.bold),),
                            SizedBox(height: 10,),
                            Text("${s.data.data.dailyOrder}",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.bold),),
                          ],
                        ),
                        Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          ...
                          children: [
                            Text("Daily Production",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.bold),),
                            SizedBox(height: 10,),
                            Text("${s.data.data.dailyProduction}",style: TextStyle(color: Colors.white,fontSize: 14,fontWeight: FontWeight.bold),),
                          ],
                        ),
                        Column(
                          mainAxisAlignment: MainAxisAlignment.start,
...
class _SendNotificationDialogState extends State<SendNotificationDialog> {
  ...
  Widget build(BuildContext context) {
    return Platform.isIOS ? CupertinoAlertDialog(
      title: Text('Send Product Notification to Sales', textAlign: TextAlign.center,),
      content: Container(
        height: 200,
          ...
          onPressed: () {
            ...
            for(int i=0; i<product1.length; i++){
              ...
              if(product == product1[i].productName){
                print("object $product ${product1[i].productName} ${product1[i].id}");
                setState(() {
                  id = product1[i].id;
                });
              }
  ...
  sendNotification(String idPro) async{
    ...
    pr.show();
    var response = await http.post(Uri.parse(Connection.productiontoNotificationSales), body: {
    ...
    if (results['status'] == true) {
      ...
      Alerts.showAlertAndBack(context, "Notification Send Failed", "Something Went Wrong");
    }
  }
