          ...
          return RefreshIndicator(
            onRefresh: () {
              return Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(builder: (builder) => CustomerCreditPage()),
                  (route) => false);
            },
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(context,
                                  ...
                                  return AddCreditsPage(
                                    customerId:
                                        s.data.allCustomerCredit[i].customerId,
                                    customerName: s
                                        .data.allCustomerCredit[i].customerName,
                                  );
                                }));
                                        ...
                                        children: [
                                          Padding(
                                              padding: EdgeInsets.symmetric(
                                                  horizontal: 10),
                                              child: Text(
                                                "Name: ${s.data.allCustomerCredit[i].customerName}",
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 16,
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "${s.data.allCustomerCredit[i].creditLimit}",
                                                  textAlign: TextAlign.center,
                                                  style: TextStyle(
                                                      color: Colors.black),
                                                ),
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "${s.data.allCustomerCredit[i].creditDays}",
                                                  textAlign: TextAlign.center,
                                                  style: TextStyle(
                                                      color: Colors.black),
                                                ),
