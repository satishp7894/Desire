...
class _SalesManListPageState extends State<SalesManListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Salesman List", style: TextStyle(color: Colors.black), textAlign: TextAlign.center,),
        centerTitle: true,
  ...
  Widget _body(){
    return RefreshIndicator(
      color: kPrimaryColor,
      onRefresh: () {
        return Navigator.pushReplacement(context, MaterialPageRoute(builder: (builder) => SalesManListPage()));
      },
                ...
                child: Column(
                  children: [
                    _searchResult.length == 0 ? ListView.separated(
                      ...
                      itemBuilder: (c,i){
                        salesmanList[i].isActive == "0" ? status.add(false) : status.add(true);
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                          ...
                                          child: Text("Name: ${salesmanList[i].firstname} ${salesmanList[i].lastname}",
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(width: 5,),
                                            salesmanList[i].isActive == "0" ? Text("Blocked", textAlign: TextAlign.center, style: TextStyle(color: Colors.redAccent,),) : Text("Active", textAlign: TextAlign.center, style: TextStyle(color: Colors.green),),
                                          ],
                                        ),),
                                      SizedBox(height: 10,),
                                      Padding(
                                          padding: EdgeInsets.symmetric(horizontal: 10),
                                          child: Text("Email : ${salesmanList[i].email}", style: TextStyle(color: Colors.black),)),
                                    ],
                                  ),
                                ),
                                Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        GestureDetector(
                                          onTap: (){
                                            Navigator.push(context, MaterialPageRoute(builder: (builder) => SalesmanDetailsPage(salesman: salesmanList[i],)));
                                          },
                                          child: Container(
                                            height: 30,
                                            width: 20,
                                        ...
                                        GestureDetector(
                                          onTap: (){
                                            Navigator.push(context, MaterialPageRoute(builder: (builder) => SalesEditPage(salesman: salesmanList[i], userId: '2',)));
                                          },
                                          child: Container(
                                            height: 30,
                                            width: 20,
                                        ...
                                        GestureDetector(
                                          onTap: (){
                                            Navigator.push(context, MaterialPageRoute(builder: (builder) => SalesCustomerListPage(salesId: salesmanList[i].userId)));
                                          },
                                          child: Container(
                                            height: 30,
                                            width: 20,
                                ...
                                Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        IconButton(icon: Icon(Icons.block, color: kPrimaryColor,), onPressed: (){
                                          //updateStatusId("1",_searchResult[i].userId);
                                        }) :
                                        IconButton(icon: Icon(Icons.block, color: Colors.blue,), onPressed: (){
