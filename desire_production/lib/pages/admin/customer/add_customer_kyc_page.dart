...
class AddCustomerKycPage extends StatefulWidget {

  final String customerId;
  AddCustomerKycPage({@required this.customerId, });

  @override
  _AddCustomerKycPageState createState() => _AddCustomerKycPageState();

}

class _AddCustomerKycPageState extends State<AddCustomerKycPage> with Validator{
    ...
    return SafeArea(
        child: Scaffold(
          body: RefreshIndicator(
            onRefresh: (){
              return Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => AddCustomerKycPage(customerId: widget.customerId, )), (route) => false);
            },
                            ...
                            GestureDetector(
                              ...
                              onTap: () {
                                if(kyc2.text.isEmpty){
                                  ...
                                  if(Validator().validateAdhaarNo(kyc2.text) == "Invalid Adhaar Number"){
                                    Alerts.showAlertAndBack(context, "Invalid", "Please Enter Valid Adhaar Number");
                                  } else{
                            ...
                            GestureDetector(
                              ...
                              onTap: () {
                                if(kyc1.text.isEmpty){
                                  ...
                                  if(Validator().validateGSTNo(kyc1.text) == "Invalid GST Number"){
                                    Alerts.showAlertAndBack(context, "Invalid", "Please Enter Valid GST Number");
                                  }else {
                            ...
                            GestureDetector(
                              ...
                              onTap: () {
                                if(kyc3.text.isEmpty){
                                  ...
                                  if(Validator().validatePANNo(kyc3.text) == "Invalid PAN Number"){
                                    Alerts.showAlertAndBack(context, "Invalid", "Please Enter Valid PAN Number");
                                  }else {
  ...
  _uploadProfilePictureGallery1() async {
    print("values from text ${widget.customerId}, ${kyc1.text}");
    ...
    String value = await _apiClient.updateProfilePhoto(_imageFile1,"${widget.customerId}","3","${kyc1.text}");
    print("value $value");
  ...
  _uploadProfilePictureGallery2() async {
    print("values from text ${widget.customerId}, ${kyc2.text}");
    final _pickedPic = await _imagePicker.pickImage(source: ImageSource.gallery);
    ...
    pr.show();
    final _apiClient = ApiClient();
    String value = await _apiClient.updateProfilePhoto(_imageFile2,"${widget.customerId}","2","${kyc2.text}");
    print("value $value");
  ...
  _uploadProfilePictureGallery3() async {
    ...
    print("values from text ${widget.customerId}, ${kyc3.text}");
    ...
    String value = await _apiClient.updateProfilePhoto(_imageFile3,"${widget.customerId}","1","${kyc3.text}");
