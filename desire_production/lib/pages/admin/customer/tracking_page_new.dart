...
import 'package:desire_production/bloc/order_tracking_bloc.dart';
...
class TrackingPageNew extends StatefulWidget {
  ...
  const TrackingPageNew({@required this.id, @required this.orderId, @required this.orderName, @required this.status, @required this.totalAmount, @required this.totalQty, @required this.product, @required this.trackId});
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Center(child: Text("Your Order is under processsing please wait for confirmation.", textAlign: TextAlign.center,)),
        ) :
            ...
            builder: (c, s) {
              ...
              return Column(
                ...
                children: [
                  ...
                  RefreshIndicator(
                    onRefresh: (){
                      return Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => TrackingPageNew(id: widget.id, orderId: widget.orderId, orderName: widget.orderName, status: true, totalQty: widget.totalAmount, totalAmount: widget.totalQty, trackId: widget.trackId, product: widget.product,)), (route) => false);
                    },
