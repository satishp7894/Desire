                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            s.data.data[i].approveRejectStatus == "1"
                                ? Container(
                                    child: Icon(
                                      Icons.done,
          ...
          child: DefaultButton(
            ...
            press: () {
              ...
              if (kyc.isNotEmpty && (kyc.length == 2 || kyc.length == 3)) {
                ...
                print(
                    "object checks value ${kyc.where((e) => e == "false").length}");
  ...
  approveKyc(String kycId) async {
    ...
    if (results['status'] == true) {
      ...
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(
              builder: (build) => CustomerKYCDetailsPage(
                    customerId: widget.customerId,
                  )),
          (route) =>
              false); //Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder)=>HomePage()), (route) => false);
    } else {
