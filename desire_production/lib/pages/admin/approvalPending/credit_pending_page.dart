...
class _CreditPendingPageState extends State<CreditPendingPage> {
    ...
    return RefreshIndicator(
      ...
      onRefresh: () {
        return Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (builder) => CreditPendingPage()),
        );
      },
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                                padding: EdgeInsets.symmetric(
                                                    horizontal: 10),
                                                child: Text(
                                                  "Pending Credit Limit: ${customerList[i].pendingCreditLimit}",
                                                  textAlign: TextAlign.left,
                                                  style: TextStyle(
                                                    color: Colors.black,
                                                  ),
                                                ...
                                                Padding(
                                                    padding:
                                                        EdgeInsets.symmetric(
                                                            horizontal: 10),
                                                    child: Text(
                                                      "Pending Credit Limit: ${_searchResult[i].pendingCreditLimit}",
                                                      textAlign: TextAlign.left,
                                                      style: TextStyle(
                                                        color: Colors.black,
                                                      ),
  ...
  approveCredits(String status, String customerId) async {
    // String value;
    ...
    pr.show();
    var response = await http.post(Uri.parse(Connection.approveCredits), body: {
