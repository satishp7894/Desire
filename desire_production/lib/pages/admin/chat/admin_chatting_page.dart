      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(adminChat.senderName, style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: kWhite),),
              SizedBox(height: 5,),
              Text(adminChat.message, style: TextStyle(fontSize: 15,color: kWhite),),
              SizedBox(height: 5,),
              Text(adminChat.date.split(" ").first, style: TextStyle(fontSize: 10,color: kWhite),),
            ],
          ),
        ),
      ),
