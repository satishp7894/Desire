import 'package:desire_production/bloc/InvoiceSalesDetailBloc.dart';
...
class _InvoiceDetailSalesPageState extends State<InvoiceDetailSalesPage> {
  ...
  onSearchTextChangedICD(String text) async {
    ...
    _order.forEach((exp) {
      if (exp.modelNoId.contains(text) || exp.productName.toLowerCase().contains(text.toLowerCase()))
  ...
  Future savePdf() async {
    if (await _reqPer(Permission.storage)) {
      var dir = await DownloadsPathProvider.downloadsDirectory;
      print("object directory path ${dir.path}");
      File file = File(dir.path + "/Invoices.pdf");
      path = dir.path + "/Invoices.pdf";
