...
class _AdminUserListPageState extends State<AdminUserListPage> with Validator {
      ...
      child: SafeArea(
        ...
        appBar: AppBar(
          ...
          leading: Builder(
            builder: (c) {
              return IconButton(
                icon: Image.asset("assets/images/logo_new.png"),
                onPressed: () {
      ...
      child: RefreshIndicator(
        ...
        onRefresh: () {
          return Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(
                  builder: (builder) => AdminUserListPage(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: AspectRatio(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Image.network(
                                                            "http://loccon.in/desiremoulding/upload/Image/Admin/${userList[i].userPhoto}"),
                                                      ),
                                                    ),
                                                  ),
                                                ),
                                                  ...
                                                  : SizedBox(
                                                      ...
                                                      child: AspectRatio(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Image.network(
                                                              "http://loccon.in/desiremoulding/upload/Image/Admin/${_searchResult[i].userPhoto}"),
                                                        ),
                                                      ),
                                                    ),
                                              Expanded(
  ...
  deleteUser(String userId) async {
    ...
    if (results['status'] == true) {
      final snackBar =
          SnackBar(content: Text('Admin Profile Deleted Successfully'));
      ...
      Alerts.showAlertAndBack(context, 'Error',
          'Sales Profile not Updated. Please try again later');
    }
  }
  ...
  Future<String> addUser(File photo) async {
    ...
    var request =
        http.MultipartRequest("POST", Uri.parse(Connection.addAdminUser));
    ...
    request.files.add(await http.MultipartFile.fromPath('image', photo.path,
        filename: 'DisplayPicture${uName.text}.jpg',
