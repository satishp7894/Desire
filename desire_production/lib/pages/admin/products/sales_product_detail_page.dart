...
class SalesProductDetailsPage extends StatefulWidget {
  ...
  SalesProductDetailsPage({@required this.product, @required this.customerId, @required this.customerName, @required this.salesId,});
...
class _SalesProductDetailsPageState extends State<SalesProductDetailsPage> {
  ...
  addToCart() async{
    ...
    if (results['status'] == true){
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder)=>SalesProductDetailsPage(product: widget.product, customerName: widget.customerName, customerId: widget.customerId, salesId: widget.salesId,)), (route) => false);
    } else{
