...
class CustomerPricingPage extends StatefulWidget {
  ...
  const CustomerPricingPage({@required this.customerId, @required this.salesId});
...
class _CustomerPricingPageState extends State<CustomerPricingPage> {
  ...
  Widget _body(){
    return RefreshIndicator(
      onRefresh:(){
        return Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => CustomerPricingPage(customerId: widget.customerId, salesId: widget.salesId,)), (route) => false);
      },
        ...
        child: Column(
          children: [
                  ...
                  as = s;
                    ...
                    if (check.length == 0) {
                      for(int i=0; i<s.data.modelList.length; i++){
                        ...
                        newPrice.add(TextEditingController(text: s.data.modelList[i].listPrice));
                        print("checked value ${check[i]}");
                      }
                    }
                  print("object length ${s.data.modelList.length} ${check.length}");
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border(top: BorderSide(color: Colors.black),right: BorderSide(color: Colors.black),bottom: BorderSide(color: Colors.black), left: BorderSide(color: Colors.black)),
                                    ),
                                    child: Checkbox(
                                      value: checkAll,
                                  ...
                                  Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text('Model Name', //style: content1,
                                  ...
                                  Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text('Sales Price', //style: content1,
                                          textAlign: TextAlign.center,),
                                        alignment: Alignment.center,
                                      )
                                  ),
                                  Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text('New Price', //style: content1,
                                          textAlign: TextAlign.center,),
                                        alignment: Alignment.center,
                                      )
                                  ),
                                        ...
                                        children: [
                                            ...
                                            child: Checkbox(
                                              ...
                                              onChanged: (value) {
                                                ...
                                                if(check[i] == true){
                                                  ...
                                                  send.remove(s.data.modelList[i].modelNoId);
                                                }
                                              },
                                            ),
                                          ),
                                          Expanded(
                                              ...
                                              child: Container(
                                                ...
                                                child: Text('${s.data.modelList[i].modelNo}', //style: content1,
                                                  textAlign: TextAlign.center,),
                                                alignment: Alignment.center,
                                              )
                                          ),
                                          Expanded(
                                              ...
                                              child: Container(
                                                ...
                                                child: Text('${s.data.modelList[i].customerPrice}', //style: content1,
                                                  textAlign: TextAlign.center,),
                                                alignment: Alignment.center,
                                              )
                                          ),
                                          Expanded(
                                              ...
                                              child: Container(
                                                ...
                                                child: Text('${s.data.modelList[i].salesPrice}', //style: content1,
                                                  textAlign: TextAlign.center,),
                                                alignment: Alignment.center,
                                              )
                                          ),
            ...
            Padding(
              ...
              child: DefaultButton(text: "Submit Pricing", press: (){
                ...
                if(send.length > 0){
                  ...
                  final snackBar = SnackBar(
                      content: Text("No Products Selected", textAlign: TextAlign.center,));
  ...
  submitPricing() async{
    ...
    for (int i = 0; i < send.length; i++) {
      ...
      print("object values to be added ${send[i].modelNo} ${send[i].listOldPrice} ${newPrice[i].text} $price");
      var prices = {
        '"model_no_id"': "\"${send[i].modelNoId}\"",
        '"price"': "\"$price\"",
        '"old_price"': send[i].listOldPrice == "" ? "\"${newPrice[i].text}\"" : "\"${send[i].listOldPrice}\"",
      };
    ...
    if (results['status'] == true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(snackBar);
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => CustomerPricingPage(customerId: widget.customerId, salesId: widget.salesId)), (Route<dynamic> route) => false);
    } else {
