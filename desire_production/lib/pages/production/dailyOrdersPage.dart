...
class _DailyOrdersPageState extends State<DailyOrdersPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: (){
        return widget.page == "production" ? Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => DashboardPageProduction(page: widget.page,)), (route) => false) : Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => DashboardPageProduction(page: widget.page,)), (route) => false);
      },
      child: Scaffold(
  ...
  Widget _body(){
    return RefreshIndicator(
      color: kPrimaryColor,
      onRefresh: (){
        return Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => DailyOrdersPage(page: widget.page,)), (route) => false);
      },
        ...
        child: StreamBuilder<DailyOrdersListModel>(
            ...
            builder: (c, s) {
              ...
              return _order.length == 0 ? Center(
                heightFactor: 20,
                child: Text("No Daily Orders Available",style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold),),):
              Container(
                              ...
                              children: [
                                ...
                                Expanded(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text('Model Number', //style: content1,
                                        textAlign: TextAlign.center,style: TextStyle(color: Colors.white,),),
                                      alignment: Alignment.center,
                                    )
                                ),
                                  ...
                                  child: Checkbox(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      if(checkAll == true){
                                        for(int i=0; i<s.data.data.length; i++){
                                          check[i] = true;
                                          send.add(s.data.data[i].dailyOrderId);
                                        }
                                      } else{
                                        for(int i=0; i<s.data.data.length; i++){
                                          check[i] = false;
                                ...
                                Expanded(
                                    child: Container(
                                      ...
                                      child: Text('Details' , style: TextStyle(color: Colors.white),//style: content1,
                                        textAlign: TextAlign.center,),
                                      alignment: Alignment.center,
                                    )
                                ),
                                          ...
                                          child: Checkbox(
                                            ...
                                            onChanged: (value) {
                                              ...
                                              if(check[i] == true){
                                                ...
                                                send.remove(s.data.data[i].dailyOrderId);
                                              }
                                            },
                                          ),
                                        ),
                                        Expanded(
                                            child: GestureDetector(
                                              onTap: (){
                                                ...
                                                => DailyOrdersListByModelNumber(modelNoId: s.data.data[i].modelNoId,
                                              ...
                                              child: Container(
                                                ...
                                                child: Text('View Details',
                                                  style: TextStyle(decoration: TextDecoration.underline,fontSize: 14,color: kPrimaryColor),//style: content1,
                                                  textAlign: TextAlign.center,),
                                                alignment: Alignment.center,
                                              ),
                                            )
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: Text('Sr No.', style: TextStyle(color: Colors.white),//style: content1,
                                    textAlign: TextAlign.center,),
                                  //alignment: Alignment.center,
                                ),
                                Expanded(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text('Model Number', style: TextStyle(color: Colors.white), //style: content1,
                                        textAlign: TextAlign.center,),
                                      alignment: Alignment.center,
                                    )
                                ),
                                Expanded(
                                    child: Container(
                                      ...
                                      child: Text('Qty',  style: TextStyle(color: Colors.white),//style: content1,
                                        textAlign: TextAlign.center,),
                                      alignment: Alignment.center,
                                    )
                                ),
                                    ...
                                    onChanged: (value) {
                                      ...
                                      if(checkAll == true){
                                        for(int i=0; i<_searchResult.length; i++){
                                          check[i] = true;
                                          send.add(_searchResult[i].dailyOrderId);
                                        }
                                      } else{
                                        for(int i=0; i<_searchResult.length; i++){
                                          check[i] = false;
                                    ...
                                    child: Row(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('${i+1}',style: TextStyle(fontSize: 12,color: Colors.black,fontWeight: FontWeight.bold), //style: content1,
                                            textAlign: TextAlign.center,),
                                          //alignment: Alignment.center,
                                        ),
                                        Expanded(
                                            ...
                                            child: Container(
                                              ...
                                              child: Text('${_searchResult[i].modelNo}',style: TextStyle(fontSize: 12,color: Colors.black,fontWeight: FontWeight.bold),//style: content1,
                                                textAlign: TextAlign.center,),
                                              alignment: Alignment.center,
                                            )
                                        ),
                                        Expanded(
                                            child: Container(
                                              ...
                                              child: Text('${_searchResult[i].qty}',style: TextStyle(fontSize: 12,color: Colors.black,fontWeight: FontWeight.bold), //style: content1,
                                                textAlign: TextAlign.center,),
                                              alignment: Alignment.center,
                                            )
                                        ),
                                          ...
                                          child: Checkbox(
                                            ...
                                            onChanged: (value) {
                                              ...
                                              if(check[i] == true){
                                                ...
                                                send.remove(_searchResult[i].dailyOrderId);
                                              }
                                            },
                                          ),
                                        ),
                                        Expanded(
                                            child: GestureDetector(
                                              onTap: (){
                                                Navigator.push(context, MaterialPageRoute(builder: (context)
                                                => DailyOrdersListByModelNumber(modelNoId: _searchResult[i].modelNoId,
                                                  modelNo: _searchResult[i].modelNo,
                                                  status: 1,
                                                )
                                                ));
                                              },
  ...
  sendToDailyProduction(String value) async{
    ...
    pr.show();
    var response = await http.post(Uri.parse("http://loccon.in/desiremoulding/api/ProductionApiController/dailyOrderToDailyProduction"), body: {
    ...
    if (results['status'] == true) {
      ...
      Alerts.showAlertAndBackPro(context, "Success", "Successfully Order Sent To Production",widget.page);
    } else {
      Alerts.showAlertAndBackPro(context, "Something Went Wrong", "Could not send to Production",widget.page);
    }
  }
                            ...
                            return pw.Container(
                                ...
                                child: pw.Row(
                                  ...
                                  children: [
                                    ...
                                    pw.Container(
                                      child: pw.Text('${as.data.data[i].qty}', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 15),
                                        textAlign: pw.TextAlign.center,),
                                      width: 60,
                                      height: 52,
                                      alignment: pw.Alignment.center,
