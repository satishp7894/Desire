...
class DailyProductionListByModelNumber extends StatefulWidget {
  ...
  const DailyProductionListByModelNumber(
      {Key key, this.modelNo, this.modelNoId, this.dailyProductionId})
      : super(key: key);

  @override
  _DailyProductionListByModelNumberState createState() =>
      _DailyProductionListByModelNumberState();
}

class _DailyProductionListByModelNumberState
    extends State<DailyProductionListByModelNumber> {
    ...
    return RefreshIndicator(
      ...
      onRefresh: () {
        return Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(
                builder: (builder) => DailyProductionListByModelNumber(
            ...
            builder: (c, s) {
              ...
              return _order.length == 0
                  ? Center(
                      heightFactor: 20,
                      child: Text(
                        "No Orders of Model No - ${widget.modelNo} in Production",
                        style: TextStyle(
                                                        ...
                                                        children: [
                                                          ...
                                                          Expanded(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Text(
                                                                  '${s.data.data[i].productQuantity}', //style: content1,
                                                                  textAlign:
                                                                      TextAlign
                                                                          .center,
                                                                  style: TextStyle(
                                                          ...
                                                          Expanded(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Text(
                                                                  '${s.data.data[i].perBoxStick}', //style: content1,
                                                                  textAlign:
                                                                      TextAlign
                                                                          .center,
                                                                  style: TextStyle(
  ...
  onSearchTextChangedICD(String text) async {
    ...
    _order.forEach((exp) {
      if (exp.productName.contains(text)) _searchResult.add(exp);
    });
  ...
  sendToWareHouse(String orderDetailId) async {
    ...
    var response = await http.post(
        Uri.parse(
            "http://loccon.in/desiremoulding/api/ProductionApiController/dailyProductionToWarehouse"),
        body: {
    ...
    if (results['status'] == true) {
      ...
      Alerts.showAlertAndBack(
          context, "Success", "Successfully Order Sent To WareHouse");
    } else {
      Alerts.showAlertAndBack(
        context,
        "Something Went Wrong",
        "Could not send to Warehouse",
      );
    }
  }
}
