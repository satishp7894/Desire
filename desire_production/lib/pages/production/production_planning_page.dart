...
class _ProductionPlanningPageState extends State<ProductionPlanningPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: (){
        return widget.page == "production" ? Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => DashboardPageProduction()), (route) => false) : Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => DashboardPageAdmin()), (route) => false);
      },
      child: Scaffold(
  ...
  Widget _body(){
    return RefreshIndicator(
      color: kPrimaryColor,
      onRefresh: (){
        return Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => ProductionPlanningPage(page: widget.page,)), (route) => false);
      },
                  ...
                  children: [
                              ...
                              children: [
                                ...
                                Expanded(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text('Product Name', style: TextStyle(color: Colors.white,),//style: content1,
                                        textAlign: TextAlign.center,),
                                      alignment: Alignment.center,
                                    )
                                ),
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                            child: Container(
                                              ...
                                              child: Text('${s.data.product[i].qty}', //style: content1,
                                                textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold)),
                                              alignment: Alignment.center,
                                            )
                                        ),
                    ...
                    send.length > 0 ? Padding(
                      ...
                      child: DefaultButton(
                        text: "Submit",
                        press: (){
                          print("object $send ${send.toString().replaceAll("]", "").replaceAll("[", "").replaceAll(" ", "")}");
                          sendToWareHouse(send.toString().replaceAll("]", "").replaceAll("[", "").replaceAll(" ", ""));
                        },
                      ),
                    ) : Padding(
                      padding: const EdgeInsets.all(50),
  ...
  sendToWareHouse(String value) async{
    ...
    pr.show();
    var response = await http.post(Uri.parse(Connection.sendToWarehouse), body: {
    ...
    if (results['status'] == true) {
      ...
      Alerts.showAlertAndBackPlan(context, "Success", "Successfully Sent to Warehouse.", widget.page);
    } else {
      Alerts.showAlertAndBackPlan(context, "Something Went Wrong", "Could not send to Production", widget.page);
    }
  }
                            ...
                            return pw.Container(
                                ...
                                child: pw.Row(
                                  ...
                                  children: [
                                    ...
                                    pw.Container(
                                      child: pw.Text('${as.data.product[i].productName}', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 15),
                                        textAlign: pw.TextAlign.center,),
                                      width: 100,
                                      height: 52,
                                      padding: pw.EdgeInsets.only(left:10),
                                    ...
                                    pw.Container(
                                      child: pw.Text('${as.data.product[i].qty}', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 15),
                                        textAlign: pw.TextAlign.center,),
                                      width: 60,
                                      height: 52,
                                      alignment: pw.Alignment.center,
