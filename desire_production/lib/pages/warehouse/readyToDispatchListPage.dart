...
class _ReadyToDispatchListPageState extends State<ReadyToDispatchListPage> {
                                                              ...
                                                              child: IconButton(
                                                                  onPressed:
                                                                    ...
                                                                    Navigator
                                                                      ...
                                                                      context,
                                                                      MaterialPageRoute(
                                                                          builder: (builder) => AddNewInvoiceOrderPage(s
                                                                              .data
                                                                              .data[i]
                                                                              .customerId)),
                                                                    );
                                                                    ...
                                                                    IconButton(
                                                                        onPressed:
                                                                          ...
                                                                          Navigator
                                                                              .push(
                                                                            context,
                                                                            MaterialPageRoute(builder: (builder) => AddNewInvoiceOrderPage(_searchResult[i].customerId)),
                                                                          );
                                                                        },
                                                                        icon:
                                                                            Icon(
  ...
  onSearchTextChangedICD(String text) async {
    ...
    _list.forEach((exp) {
      if (exp.orderNumber.toLowerCase().contains(text.toLowerCase()) ||
