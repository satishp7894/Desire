...
class ReadyToDispatchListPage extends StatefulWidget {
  ...
  @override
  _ReadyToDispatchListPageState createState() => _ReadyToDispatchListPageState();
}
...
class _ReadyToDispatchListPageState extends State<ReadyToDispatchListPage> {
  ...
  Widget _body(){
    return RefreshIndicator(
        color: kPrimaryColor,
        onRefresh: (){
          return widget.page == "warHouse" ? Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => ReadyToDispatchListPage(page: 'warHouse')), (route) => false) : Navigator.pushReplacement(context, MaterialPageRoute(builder: (builder) => ReadyToDispatchListPage(page: 'admin')),);
        },
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text('Customer Id', //style: content1,
                                              textAlign: TextAlign.center,style: TextStyle(color: Colors.white)),
                                          alignment: Alignment.center,
                                        )
                                    ),
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Text('${s.data.data[i].customerId}', //style: content1,
                                                    textAlign: TextAlign.center,),
                                                  alignment: Alignment.center,
                                                )
                                            ),
                                                ...
                                                child: IconButton(
                                                    onPressed: (){
                                                     // sendToDispatch(s.data.data[i].customerName);
                                                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (builder) => DispatchOrderDetailsPage(orderId: s.data.data[i].orderId,
                                                      page: widget.page,
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              flex: 2,
                                                child: Container(
                                                  ...
                                                  child: Text('${_searchResult[i].customerId}', //style: content1,
                                                    textAlign: TextAlign.center,),
                                                  alignment: Alignment.center,
                                                )
                                            ),
                                            ...
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: IconButton(
                                                    onPressed: (){
                                                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (builder) => DispatchOrderDetailsPage(orderId:_searchResult[i].orderId,
                            ...
                            return pw.Container(
                                ...
                                child: pw.Row(
                                  ...
                                  children: [
                                    ...
                                    pw.Container(
                                      child: pw.Text('${as.data.data[i].customerId}', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 15),
                                        textAlign: pw.TextAlign.center,),
                                      width: 100,
                                      height: 52,
                                      padding: pw.EdgeInsets.only(left:10),
                                    ...
                                    pw.Container(
                                      child: pw.Text('${as.data.data[i].orderNumber}', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 15),
                                        textAlign: pw.TextAlign.center,),
                                      width: 60,
                                      height: 52,
                                      alignment: pw.Alignment.center,
  ...
  onSearchTextChangedICD(String text) async {
    ...
    _list.forEach((exp) {
      if (exp.orderNumber.contains(text))
