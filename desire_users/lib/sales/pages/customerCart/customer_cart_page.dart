...
class CustomerCartPage extends StatefulWidget {
  ...
  const CustomerCartPage({Key key,this.customerId, this.customerName, this.customerMobile, this.customerEmail}) : super(key: key);
...
class _CustomerCartPageState extends State<CustomerCartPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Customer Basket",style: TextStyle(color: kBlackColor),),
      ),
      body: body(),
    );
  }
            ...
            children: [
              ...
              address == null ? Center(
                child: TextButton(
                  ...
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (builder) => CustomerAddressViewPage(customerId: widget.customerId, page: "cart",customerName: widget.customerName,)));
                  },
                ),
              ) :Center(
                child: TextButton(
                  ...
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (builder) => CustomerAddressViewPage(customerId: widget.customerId, page: "cart",)));
                  },
                ),
              ),
  ...
  navigateHome(){
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>SalesHomePage(
      salesManId: salesId    ,
    )));
  }
...
class _CartItemsTileState extends State<CartItemsTile> {
  ...
  changeQty(String quantity) async{
    ...
    if (results['status'] == true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(snackBar);
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (builder) => CustomerCartPage(customerId: widget.customerId,customerName: widget.customerName,customerEmail: widget.customerEmail,customerMobile: widget.customerMobile)));
