...
class CustomerCreditPage extends StatefulWidget {
  ...
  const CustomerCreditPage(
      {@required this.salesId, @required this.name, @required this.email});
          ...
          return RefreshIndicator(
            ...
            onRefresh: () {
              return Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(
                      builder: (builder) => CustomerCreditPage(
                            salesId: widget.salesId,
                            name: widget.name,
                            email: widget.email,
                          )),
                                        ...
                                        children: [
                                          Padding(
                                              padding: EdgeInsets.symmetric(
                                                  horizontal: 10),
                                              child: Text(
                                                "Name: ${s.data.creditList[i].customerName}",
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 16,
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "${s.data.creditList[i].creditLimit}",
                                                  textAlign: TextAlign.center,
                                                  style: TextStyle(
                                                      color: kPrimaryColor),
                                                ),
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "${s.data.creditList[i].creditDays}",
                                                  textAlign: TextAlign.center,
                                                  style: TextStyle(
                                                      color: kPrimaryColor),
                                                ),
