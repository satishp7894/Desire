...
class BrochurePage extends StatefulWidget {
  ...
  const BrochurePage(
      {@required this.name, @required this.email, @required this.salesId});
...
// temporary directory and image bytes from response is written to // that file.
  ...
  generatePdf() async {
    ...
    pr.style(
      message: 'Downloading Images. Please wait...',
    ...
    final image = pw.MemoryImage(
      (await rootBundle.load('assets/images/logo_new.png'))
          .buffer
          .asUint8List(),
    );
              ...
              pw.Container(
                  ...
                  child: pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text(
                            "Dimensions: ${send[i].dimensionsName} ${send[i].size}",
                            textAlign: pw.TextAlign.left,
                            style: pw.TextStyle(
                              fontSize: 15,
                            )),
