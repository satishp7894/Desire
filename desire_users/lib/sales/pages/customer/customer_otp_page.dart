                          ...
                          try {
                            await FirebaseAuth.instance
                              ...
                              if (value.user != null) {
                                ...
                                Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => AddCustomerKycPage(customerId: widget.customerId, salesId: widget.salesId, email: widget.email, name: widget.name)), (route) => false);
                              }
                            });
                          } catch (e) {
