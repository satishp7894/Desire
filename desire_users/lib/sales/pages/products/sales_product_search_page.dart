...
class SalesProductSearchPage extends StatefulWidget {
  ...
  SalesProductSearchPage({@required this.search, @required this.customerList,this.customerId});
...
class _SalesProductSearchPageState extends State<SalesProductSearchPage> {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () {
        return Navigator.pushReplacement(context, MaterialPageRoute(builder: (c) => SalesProductSearchPage(search: widget.search, customerList: widget.customerList,)));
      },
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onEditingComplete: (){
          ...
          Navigator.push(context, MaterialPageRoute(builder: (c) => SalesProductSearchPage(search: searchController.text, customerList: widget.customerList,)));
        },
            ...
            builder: (c, s) {
              ...
              return StaggeredGridView.countBuilder(
                ...
                itemBuilder: (BuildContext context, int index) => GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (c) => SalesProductDetailsPage(product: s.data.product[index], page: "home", snapshot: s.data.product, customerList: widget.customerList,)));
                  },
                  child: Column(
