...
class SalesProductCategoryPage extends StatefulWidget {
  ...
  SalesProductCategoryPage({@required this.id, @required this.name, @required this.customerList,this.customerId});
    ...
    return StreamBuilder<ProductModel>(
        ...
        builder: (c,s){
          ...
          return RefreshIndicator(
            onRefresh: (){
              return Navigator.pushReplacement(context, MaterialPageRoute(builder: (c) => SalesProductCategoryPage(id:  widget.id, name: widget.name,customerList: customerList,)));
            },
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Hero(
                            ...
                            child: Image.network("${s.data.imagepath}${s.data.product[i].image[0]}"),
                          ),
                        ),
                      ),
                      Expanded(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    "₹${s.data.product[i].customerprice}",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.w600,
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: DefaultButton(text: "View", press: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (c) => SalesProductDetailsPage(product: s.data.product[i], page: "home", snapshot: s.data.product,customerList: customerList,)));
                                    },),
                                  ),
                                )
                              ],
