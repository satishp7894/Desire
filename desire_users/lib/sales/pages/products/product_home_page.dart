...
class _ProductHomePageState extends State<ProductHomePage> {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      color: kPrimaryColor,
      onRefresh: () {
        return Navigator.pushReplacement(context, MaterialPageRoute(builder: (c) => ProductHomePage(
      ...
      child: SafeArea(
        child: Scaffold(
            appBar: AppBar(
              ...
              title: Text("Products for ${widget.customerName}",textAlign: TextAlign.center,style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold,color: kBlackColor),),
              centerTitle: true,
      ...
      children: [
        Padding(
          ...
          child: _sectionTile("All Model", () {
            Navigator.push(context, MaterialPageRoute(builder: (c) => ModelListPage(customerId: widget.customerId,customerName: widget.customerName,)));
          }),
        ),
        SizedBox(height: 10),
                  ...
                  children: [
                    ...List.generate(
                      ...
                      allModelSnapshot.data.data.length,
                          (index) {
                        return ModelCard(data: allModelSnapshot.data.data[index], snapshot: allModelSnapshot.data.data, orderCount: 0, customerId: widget.customerId,imagePath: allModelSnapshot.data.imagepath,customerName: widget.customerName,);
                      },
                    ),
                    SizedBox(width: 20),
                  ],
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onEditingComplete: (){
          ...
          Navigator.push(context, MaterialPageRoute(builder: (c) => CustomerSearchPage(searchKeyword: searchController.text, customerId: widget.customerId,customerName: widget.customerName,)));
        },
                ...
                child: Row(
                  ...
                  children: List.generate(
                    s.data.data.length,
                      ...
                      press: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>SalesModelFromCategoryPage(categoryId:s.data.data[index].categoryId ,categoryName: s.data.data[index].categoryName,customerId: widget.customerId,customerName: widget.customerName,)));
      ...
      children: [
        Padding(
          ...
          child: _sectionTile("New Arrival Products", () {
            Navigator.push(context, MaterialPageRoute(builder: (c) => SalesProductListPage(snapshot: news.data.product, title: "New Products", refresh: false,customerList: customersList,)));
          }),
        ),
        SizedBox(height: 20),
        SingleChildScrollView(
                  ...
                  children: [
                    ...List.generate(
                      news.data.product.length,
                          (index) {
                        return ProductCard(product: news.data.product[index], customerList: customersList, snapshot: news.data.product,productId: news.data.product[index].id,customerId: widget.customerId
                          ,);
                      },
                    ),
                    SizedBox(width: 20),
      ...
      children: [
        Padding(
          ...
          child: _sectionTile("Best Seller Products", () {
            Navigator.push(context, MaterialPageRoute(builder: (c) => SalesProductListPage(snapshot: bests.data.product, title: "Best Seller Products", refresh: false,customerList: customersList,customerId: widget.customerId,)));
          }),
        ),
        SizedBox(height: 20),
        SingleChildScrollView(
                  ...
                  children: [
                    ...List.generate(
                      bests.data.product.length,
                          (index) {
                        return ProductCard(product: bests.data.product[index], customerList: customersList, snapshot: bests.data.product,customerId: widget.customerId,productId: bests.data.product[index].id,);
                      },
                    ),
                    SizedBox(width: 20),
                  ],
...
class ProductCard extends StatelessWidget {
  ...
  final List<UserModel> customerList;final customerId , productId;
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: GestureDetector(
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (c) => SalesProductFromModelDetailPage(customerId: customerId,productId: productId,))),
          child: Column(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: SizedBox(
        width: width,
        child: GestureDetector(
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (c) => SalesAccessoryDetailPage(page: "home",product: product, customerList: customerList, snapshot: snapshot,))),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
