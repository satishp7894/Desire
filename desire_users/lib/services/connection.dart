...
static String categoryWiseModelNo = "http://loccon.in/desiremoulding/api/UserApiController/categoryWiseModelNo";
  ...
  static final String updateCredit = salesIp+"updateCredit";
  ...
  static final String submitCustomerComplaint = ip+"submitCustomerComplaint";

  static final String customerNotificationList = ip+"customerNotificationList";

  static final String clearCustomerNotification = ip+"clearCustomerNotification";

  static final String customerCreditDetails = ip+"customerCreditDetails";
