                  ...
                  Container(
                    child: Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network("${s.data.imagepath}${s.data.data[index].image[0]}",),
                      ),
                    ),
                  ),
                  SizedBox(height: 5,),
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          decoration:   s.data.data[index].customernewprice == "" ?TextDecoration.none: TextDecoration.lineThrough,
                          fontSize: s.data.data[index].customernewprice == "" ? 14:12,
                          fontWeight: FontWeight.w600,
                          color: s.data.data[index].customernewprice == "" ? kPrimaryColor :kSecondaryColor,
                        ),
                      ),
                      Text(
                        s.data.data[index].customernewprice =="" ? "": "Your Price "+"₹${s.data.data[index].customernewprice}",
                        style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.w600,
                          color:kPrimaryColor,
