...
class VerifyKycScreenOld extends StatefulWidget {
  final String userId;
  final String pagerTab;

  const VerifyKycScreenOld({Key key, this.userId, this.pagerTab})
      : super(key: key);
...
class _VerifyKycScreenOldState extends State<VerifyKycScreenOld> with Validator {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 2000), () {
      setState(() {
        if (widget.pagerTab != "" && controller != null) {
          current = int.parse(widget.pagerTab);
          controller.jumpToPage(int.parse(widget.pagerTab));
        }
      });
    });
        ...
        body: RefreshIndicator(
            ...
            onRefresh: () {
              return Navigator.pushAndRemoveUntil(
                  ...
                  MaterialPageRoute(
                      builder: (builder) =>
                          VerifyKycScreenOld(userId: widget.userId)),
                  (route) => false);
            },
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      CupertinoButton(
                                          color: gstNumberController
                                                      .text.isEmpty &&
                                                  gstImage == null
                                              ? kSecondaryColor
                                              : kPrimaryColor,
                                          child: Text(gstNumberController
                                                      .text.isEmpty &&
                                                  gstImage == null
                                              ? "Submit"
                                              : "Submit"),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      CupertinoButton(
                                          color: panNumberController
                                                      .text.isEmpty &&
                                                  panImage == null
                                              ? kSecondaryColor
                                              : kPrimaryColor,
                                          child: Text(panNumberController
                                                      .text.isEmpty &&
                                                  panImage == null
                                              ? "Submit"
                                              : "Submit"),
                            ...
                            child: ListView(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  readOnly: aadharNumberController.text == ""
                                      ? false
                                      : true,
                ...
                child: CupertinoButton(
                    ...
                    onPressed: () {
                      if (aadharNumberController.text.isEmpty) {
                        final snackBar = SnackBar(
                            backgroundColor: kSecondaryColor,
                            content: Text('Enter your Aadhar number/Pan Card number first',
                                style: TextStyle(color: kWhiteColor)));
                        ScaffoldMessenger.of(context).showSnackBar(snackBar);
                      } else if (aadharNumberController.text.length < 12) {
                        final snackBar = SnackBar(
                        ...
                        final snackBar = SnackBar(
                            backgroundColor: kSecondaryColor,
                            content: Text(
                              'Upload Your Aaadhar Image/ Pan Card Image First',
                              style: TextStyle(color: kWhiteColor),
                            ));
                        ScaffoldMessenger.of(context).showSnackBar(snackBar);
                      } else {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  CupertinoButton(
                      color:
                          panNumberController.text.isEmpty && panImage == null
                              ? kSecondaryColor
                              : kPrimaryColor,
                      child: Text(
                          panNumberController.text.isEmpty && panImage == null
