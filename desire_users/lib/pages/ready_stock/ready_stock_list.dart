                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(10.0),
                                child: Text("Quantity",textAlign: TextAlign.center,style: TextStyle(color: kPrimaryColor,fontSize: 14,fontWeight: FontWeight.bold),),
                              )),
                        ),
                        Expanded(
                          flex: 1,
        ...
        children: [
          Expanded(
            ...
            child: Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(10.0),
                  child: Text(readyStockList.modelNoId,textAlign: TextAlign.center,style: TextStyle(color: kBlackColor,fontSize: 14,fontWeight: FontWeight.bold),),
                )),
          ),
          Expanded(
            flex: 1,
            child: Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(10.0),
                  child: Text(readyStockList.quantity,textAlign: TextAlign.center,style: TextStyle(color: kBlackColor,fontSize: 14,fontWeight: FontWeight.bold),),
                )),
          ),
          Expanded(
            flex: 1,
