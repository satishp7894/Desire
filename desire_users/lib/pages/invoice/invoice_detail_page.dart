    ...
    return Scaffold(
      ...
      floatingActionButton:FloatingActionButton.extended(
        ...
        onPressed: (){
          generatePdf();
          savePdf();
        }, label: Text("Download Invoice",style: TextStyle(color: kWhiteColor),),icon: Icon(Icons.arrow_circle_down_sharp,color: kWhiteColor,),),
      body: _body(),
    );
      ...
      child: SingleChildScrollView(
        ...
        child: StreamBuilder<InvoiceDetailModel>(
            ...
            builder: (c, s) {
              ...
              print(
                  "object length ${_order.length} ${check.length}");
              return _order == null
                  ? Center(
                  ...
                  _searchResult.length == 0
                                      ...
                                      Expanded(
                                          ...
                                          Container(
                                            ...
                                            child: TextFormField(
                                                ...
                                                initialValue: data[i].productQuantity,
                                                maxLines: 1,
                                                enabled: false,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //
                        //                         },
                        //                         initialValue: _searchResult[i].productQuantity,
                        //                         maxLines: 1,
                        //                         textAlign: TextAlign.center,
                        //                         maxLength: 4,
                        //                         decoration: InputDecoration(
