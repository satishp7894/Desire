...
class UserSearchedPage extends StatefulWidget {
  final customerId, customerName ,customerEmail,mobileNo;
  final searchKeyword;
  const UserSearchedPage({Key key,this.customerId,this.searchKeyword,this.customerName, this.customerEmail, this.mobileNo,}) : super(key: key);

  @override
  _UserSearchedPageState createState() => _UserSearchedPageState();
}

class _UserSearchedPageState extends State<UserSearchedPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Search Result",style: TextStyle(color: kBlackColor),),
 ...
 final String customerId, customerName;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>ModelFromCategoryPage(categoryId:categoryList.categoryId ,categoryName:categoryList.categoryName,customerId:customerId,customerName: customerName,)));
      },
      child: SizedBox(
        width: 60,
        child: Column(
